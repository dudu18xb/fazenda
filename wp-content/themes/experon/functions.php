...
$GLOBALS['thinkup_theme_version'] = '1.1.5';
...
function thinkup_frontscripts() {
	...
	wp_enqueue_script( 'scrollup', get_template_directory_uri() . '/lib/scripts/plugins/scrollup/jquery.scrollUp.min.js', array( 'jquery' ), '2.4.1', 'true'  );
